...
class Hero(models.Model):
    ...
    ab_desc1 = models.CharField(max_length=400)
    ability2 = models.CharField(max_length=50)
    ab_desc2 = models.CharField(max_length=400)
    ability3 = models.CharField(max_length=50)
    ab_desc3 = models.CharField(max_length=400)
    heroic1 = models.CharField(max_length=50)
    heroic_desc1 = models.CharField(max_length=400)
    heroic2 = models.CharField(max_length=50)
    heroic_desc2 = models.CharField(max_length=400)
    ab_trait = models.CharField(max_length=50)
    trait_desc = models.CharField(max_length=400)
