...
let enUrl = ruUrl.replace("ru", "en");
let uaUrl = ruUrl.replace("ru", "ua");

document.getElementById("en").innerHTML =
  "<a href= " +
  enUrl +
  '><img class="flag"src="https://renattop.github.io/image/flags/us.svg" alt="English"></a>';
